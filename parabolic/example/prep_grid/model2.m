...
xlabel('x-axis (km)',FontSize=15,FontWeight='bold',rotation=-40,position=[2.5 -0.5]);
ylabel('y-axis (km)',FontSize=15,FontWeight='bold',rotation=50, position=[4.5 1.5]);
zlabel('z-axis (km)',FontSize=15,FontWeight='bold',rotation=0,position=[-0.3 0.5]);
view(40,60);
