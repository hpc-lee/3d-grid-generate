...
plot3(1.5, 1.0, +0.55, 'rv',MarkerSize=20,LineWidth=2);
plot3(2.0, 1.0, +0.55, 'rv',MarkerSize=20,LineWidth=2);
plot3(2.0, 2.0, +0.55, 'rv',MarkerSize=20,LineWidth=2);
plot3(2.5, 1.0, +0.1, 'rv',MarkerSize=20,LineWidth=2);
plot3(2.5, 2.0, +0.1, 'rv',MarkerSize=20,LineWidth=2);

text(1.5+0.1, 1.0-0.1, +0.5+0.25,'R1',Color='r',FontSize=20,FontWeight='bold');
text(2.0+0.1, 1.0-0.1, +0.5+0.25,'R2',Color='r',FontSize=20,FontWeight='bold');
text(2.0+0.1, 2.0-0.1, +0.5+0.25,'R3',Color='r',FontSize=20,FontWeight='bold');
text(2.5+0.1, 1.0-0.1, +0.1+0.2,'R4',Color='r',FontSize=20,FontWeight='bold');
text(2.5+0.1, 2.0-0.1, +0.1+0.2,'R5',Color='r',FontSize=20,FontWeight='bold');
plot3(3.0,0.5,0.1,'rp',MarkerSize=20,LineWidth=2);
...
xlabel('X axis (km)',FontWeight='bold',rotation=-25,position=[2.0 -0.5]);
ylabel('Y axis (km)',FontWeight='bold',rotation=40, position=[3.8 1.0]);
zlabel('Z axis (km)',FontWeight='bold',rotation=0,position=[-0.75 0.75]);
set(gca,'layer','top');
