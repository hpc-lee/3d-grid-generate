...
def main():
    ...
    # Convert to 0-based indices (p1=0, p2=100, p3=150, p4=250, p5=300, p6=400)
    p1 = 0
    p2 = 100
    p3 = 150
    p4 = 250
    ...
    # bz1 x: linspace(0, 3500, 401), y: linspace(0, 3000, 301), z=-2000
    x = np.linspace(0, 3500, nx)
    ...
    if flag_printf:
        ...
        plt.tight_layout()
        plt.savefig('../plot/para_model3.png', dpi=300, bbox_inches='tight', facecolor='white')
        plt.close(fig)
        print('Saved: ../plot/para_model3.png')
