...
subt{4}=[1,1,1];
% profile 5
subs{5}=[1,201,1];      % start from index '1'
...
surf(x{1}(201:a:401,1:a:201),y{1}(201:a:401,1:a:201),z{1}(201:a:401,1:a:201),'FaceColor', [1,1,1]);
hold on;
surf(x{2}(1:a:201,1:a:201),y{2}(1:a:201,1:a:201),z{2}(1:a:201,1:a:201),'FaceColor', [1,1,1]);
surf(x{3}(1:a:201,1:a:401),y{3}(1:a:201,1:a:401),z{3}(1:a:201,1:a:401),'FaceColor', [1,1,1]);
surf(x{3}(201:a:401,201:a:401),y{3}(201:a:401,201:a:401),z{3}(201:a:401,201:a:401),'FaceColor', [1,1,1]);
surf(x{4}(1:a:201,1:a:201),y{4}(1:a:201,1:a:201),z{4}(1:a:201,1:a:201),'FaceColor', [1,1,1]);
surf(x{5}(201:a:401,1:a:201),y{5}(201:a:401,1:a:201),z{5}(201:a:401,1:a:201),'FaceColor', [1,1,1]);
xlabel('X axis (km)',rotation=-20,position=[4.5 -4.0]);
ylabel('Y axis (km)',rotation=45,position=[6.4 -1.7]);
zlabel('Z axis (km)');
set(gca,'layer','top');
