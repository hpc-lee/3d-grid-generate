...
init_bdry(bdry_t *bdry, par_t *par)
{
  ...
  bdry->number_of_grid_points_y = par->number_of_grid_points_y;
  bdry->number_of_grid_points_z = par->number_of_grid_points_z;
  int siz_bx = bdry->number_of_grid_points_y*bdry->number_of_grid_points_z;
  int siz_by = bdry->number_of_grid_points_x*bdry->number_of_grid_points_z;
  int siz_bz = bdry->number_of_grid_points_x*bdry->number_of_grid_points_y;
